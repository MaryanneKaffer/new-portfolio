    ...
    return (
        <div className="flex mt-auto text-white w-full">
            ...
            shadow-[0_8px_30px_rgba(0,0,0,0.25)] hover:border-white/40 hover:drop-shadow-[0_0_12px_rgba(255,255,255,0.3)] bg-gradient-to-br from-white/10 to-white/5 items-center md:text-[22px] text-[18px]">
                ...
                <a href="/Maryanne Kaffer.pdf" download aria-label="download CV" className="group" target="_blank"><FaDownload className={animation} /></a>
                ...
                <p className={`${animation} ml-auto md:w-[5%] w-[13%] hover:drop-shadow-[0_0_8px_rgba(255,255,255,0.6)] md:text-[18px] text-[16px]`}>{hora}</p>
            </div>
        </div>
    )
}