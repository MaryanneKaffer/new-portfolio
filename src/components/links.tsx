...
export default function Links() {
    ...
    return (
        <div className="flex gap-0.5 mt-auto text-white w-full">
            ...
            hover:drop-shadow-[0_0_16px_rgba(255,255,255,0.35) bg-gradient-to-br from-white/20 to-white/5 items-center">
                <a href="#" className="mr-auto md:w-[5%] w-[13%] group"><FaPowerOff size={20} className="text-white transition duration-300 group-hover:scale-110 filter" /></a>
                ...
                <p className="text-white transition duration-300 filter ml-auto md:w-[5%] w-[13%] hover:drop-shadow-[0_0_8px_rgba(255,255,255,0.6)] text-[17px]">{hora}</p>
            </div>
        </div>
    )
}