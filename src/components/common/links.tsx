...
export default function Links() {
    ...
    return (
        <div className="flex mt-auto text-white w-full">
            <div className="w-full flex gap-3 p-3 rounded-md justify-center transition-all duration-300 border border-white/20 rounded-md backdrop-blur-[10px] 
            shadow-[0_8px_30px_rgba(0,0,0,0.25)] hover:border-white/40 hover:drop-shadow-[0_0_12px_rgba(255,255,255,0.3)] bg-gradient-to-br from-white/10 to-white/5 items-center md:text-[22px] text-[18px]">
                ...
                <a href={language === "pt" ? "/Maryanne Kaffer PT.pdf" : "/Maryanne Kaffer EN.pdf"} download aria-label="download CV" className="group relative" target="_blank">
                    <FaDownload className={animation} />
                    <span className="group-hover:opacity-100 transition duration-300 opacity-0 absolute bg-white/20 -top-15 w-32 text-center p-2 rounded-md left-1/2 -translate-x-1/2 text-[16px]">Download CV</span>
                </a>
                ...
                <p className={`${animation} ml-auto md:w-[5%] hover:scale-105 w-[13%] hover:drop-shadow-[0_0_8px_rgba(255,255,255,0.6)] md:text-[18px] text-[16px]`}>{hora}</p>
            </div>
        </div>
    )
}